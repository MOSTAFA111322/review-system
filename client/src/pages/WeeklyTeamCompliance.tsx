...
export default function WeeklyTeamCompliance() {
  ...
  const input = useMemo(() => ({ fiscalYearId: fiscalYearId ?? 0, period, ...(weekStart ? { weekStart } : {}), ...(weekEnd ? { weekEnd } : {}) }), [fiscalYearId, period, weekEnd, weekStart]);
