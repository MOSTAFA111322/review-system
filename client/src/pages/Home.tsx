...
export default function Home() {
  ...
  if (!user) return <div dir="rtl" className="min-h-screen flex items-center justify-center bg-slate-50 p-6"><Button onClick={() => startLogin()} className="bg-blue-700">تسجيل الدخول</Button></div>;
