...
const permissionDefinitions = [
  ...
  [PERMISSIONS.RENT_FOLLOWUPS_VIEW, "عرض كشف متابعة الإيجارات", "متابعة الإيجارات"],
  [PERMISSIONS.RENT_FOLLOWUPS_CREATE, "إضافة إفادة سداد إيجار", "متابعة الإيجارات"],
  [PERMISSIONS.RENT_FOLLOWUPS_UPDATE, "تحديث تأكيد المالك والترحيل", "متابعة الإيجارات"],
  [PERMISSIONS.RENT_FOLLOWUPS_EXPORT, "تصدير كشف متابعة الإيجارات", "متابعة الإيجارات"],
  [PERMISSIONS.RENT_OWNERS_VIEW, "عرض المالكين", "تسويات الإيجارات"],
  [PERMISSIONS.RENT_OWNERS_MANAGE, "إدارة المالكين", "تسويات الإيجارات"],
  [PERMISSIONS.RENT_SETTLEMENTS_VIEW, "عرض تسويات الإيجارات", "تسويات الإيجارات"],
  [PERMISSIONS.RENT_SETTLEMENTS_MANAGE, "إدارة تسويات الإيجارات", "تسويات الإيجارات"],
  [PERMISSIONS.RENT_SETTLEMENTS_EXPORT, "تصدير تسويات الإيجارات", "تسويات الإيجارات"],
] as const;
...
const roleDefinitions = [
  ...
  ["manager", "مدير", "إدارة الأعمال والتقارير ضمن نطاق السنوات المصرح بها", true, [
    ...
    PERMISSIONS.RENT_FOLLOWUPS_VIEW, PERMISSIONS.RENT_FOLLOWUPS_CREATE, PERMISSIONS.RENT_FOLLOWUPS_UPDATE, PERMISSIONS.RENT_FOLLOWUPS_EXPORT,
    PERMISSIONS.RENT_OWNERS_VIEW, PERMISSIONS.RENT_OWNERS_MANAGE, PERMISSIONS.RENT_SETTLEMENTS_VIEW, PERMISSIONS.RENT_SETTLEMENTS_MANAGE, PERMISSIONS.RENT_SETTLEMENTS_EXPORT,
  ...
  ["employee", "موظف", "تنفيذ الأعمال المكلف بها والتواصل حولها", true, [
    ...
    PERMISSIONS.DAILY_TASKS_VIEW, PERMISSIONS.DAILY_TASKS_UPDATE,
    PERMISSIONS.RENT_FOLLOWUPS_VIEW,
