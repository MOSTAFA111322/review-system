...
const roleDefinitions = [
  ...
  ["manager", "مدير", "إدارة الأعمال والتقارير ضمن نطاق السنوات المصرح بها", true, [
    ...
    PERMISSIONS.REVIEWS_UPDATE, PERMISSIONS.REVIEWS_ASSIGN, PERMISSIONS.REVIEWS_DELETE,
    PERMISSIONS.REVIEWS_RESTORE, PERMISSIONS.REVIEWER_STATUS_CHANGE, PERMISSIONS.EMPLOYEE_STATUS_CHANGE,
